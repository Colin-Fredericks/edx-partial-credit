    ...
    def execute_check_function(self, idset, submission):
        ...
        if isinstance(self.code, basestring):
            ...
            if isinstance(ret, dict):
                ...
                if 'ok' in ret:
                    """
                    I think this is the part to change for partial credit.
                    """
                ...
                # status, scaled grades, and messages for individual inputs
                    ...
                    grade_decimals = []
                    """
                    Here's where we fix the input_list for partial credit.
                    """
                ...
                """
                And here's where we fix it for the usual "return True" method.
                """
